...
import mbrl.env.mountain_car_continuous as mountain_car_env
...
if __name__ == "__main__":
    ...
    seed = 0
    env = mountain_car_env.Continuous_MountainCarEnv()
    env.seed(seed)
    ...
    reward_fn = reward_fns.continuous_mountain_car
    # This function allows the model to know if an observation should make the episode end
    term_fn = termination_fns.continuous_mountain_car
